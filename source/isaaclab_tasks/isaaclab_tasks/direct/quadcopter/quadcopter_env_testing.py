...
@configclass
class QuadcopterEnvCfgTesting(DirectRLEnvCfg):
    # env
...
class QuadcopterEnvTesting(DirectRLEnv):
    cfg: QuadcopterEnvCfgTesting

    def __init__(self, cfg: QuadcopterEnvCfgTesting, render_mode: str | None = None, **kwargs):
