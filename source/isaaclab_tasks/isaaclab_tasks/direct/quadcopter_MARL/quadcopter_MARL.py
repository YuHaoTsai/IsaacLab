...
class QuadcopterEnvMARL(DirectMARLEnv):
    ...
    def _reset_idx(self, env_ids: torch.Tensor | None):
        ...
        self.wind_vel[env_ids, 0] = 1.0 # torch.zeros_like(self.wind_vel[env_ids, 0]).normal_(0.0, 1.0) #-1.0  # m/s
        self.wind_vel[env_ids, 1] = 0.0 #torch.zeros_like(self.wind_vel[env_ids, 1]).normal_(0.0, 1.0)
