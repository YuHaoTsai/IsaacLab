...
class QuadcopterEnvWindow2(BaseEnvWindow):
    """Window manager for the Quadcopter environment."""

    def __init__(self, env: QuadcopterEnv2, window_name: str = "IsaacLab"):
...
@configclass
class QuadcopterEnvCfg2(DirectMARLEnvCfg):
    # env
    ...
    ui_window_class_type = QuadcopterEnvWindow2
...
class QuadcopterEnv2(DirectMARLEnv):
    cfg: QuadcopterEnvCfg2

    def __init__(self, cfg: QuadcopterEnvCfg2, render_mode: str | None = None, **kwargs):
    ...
    def _pre_physics_step(self, actions: torch.Tensor):
        ...
        #self._thrust[:, 0, 2] = self.cfg.thrust_to_weight * self._robot_weight * (actt + 1.0) / 2.0
        self._moment[:, 0, :] = self.cfg.moment_scale * thru
